          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <a onclick="return confirm('Bạn có chắc là muốn xoá thương hiệu này không?')" href="{{URL::to('delete-brand-product/'.$brand_pro->brand_id)}}" class="active styling-delete" ui-toggle-class=""><i class="fa fa-times text-danger text"></i></a>
              </td>
            </tr>
            @endforeach
          </tbody>
